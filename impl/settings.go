...
// some default constants (public and private)
const (
...
// Load settings from file if exists and setup default values for options
func (s Settings) LoadSettings() Settings {
	...
	if err == nil { // if file exists, loading from it
		...
		// compute RPC connection string to use/replace it simple
